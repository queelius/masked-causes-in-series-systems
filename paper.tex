...
interval), the identifiability analysis, and the five-family
...
(\texttt{dfr.dist}) through series composition
(\texttt{dfr.dist.series}) to masked-data likelihood
(\texttt{dfr.lik.series.md})---demonstrates this modularity:
...
environment~\citep{towell2025dfrdist,towell2025dfrdistseries,towell2025dfrliksmd}.
At the base, the \texttt{dfr.dist}
package~\citep{towell2025dfrdist} provides a hazard-function-first
...
The \texttt{dfr.dist.series} package~\citep{towell2025dfrdistseries}
...
The \texttt{dfr.lik.series.md}
package~\citep{towell2025dfrliksmd} implements the C1--C2--C3
...
\texttt{dfr.dist} ecosystem, without writing distribution-specific
likelihood code.
