...
Master's Project, Southern Illinois University Edwardsville, 2023

## Resources

- **Paper (PDF)**: [AlexTowellPaper.pdf](https://github.com/queelius/reliability-estimation-in-series-systems/blob/bookdown/pdfbook/AlexTowellPaper.pdf)
- **R Package**: [wei.series.md.c1.c2.c3](https://github.com/queelius/wei.series.md.c1.c2.c3) - Implements the methodology from this paper
